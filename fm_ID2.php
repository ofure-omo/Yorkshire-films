...
<html>
    ...
    <section>
        ...
        <body>
            <div class="sticky">
                <h1 style="font: 25px Georgia, serif; line-height: 1.8;background-color:grey;"><center>DARK RIVER</center></h1>
            </div>
            ...
            <div id="carousel2" class="carousel slide" data-ride="carousel" >
                <div class="carousel-inner" role="listbox" style="width:100%; height:500px !important;">
                    <div class="carousel-item active">
                        <center><img src="Images/fm_ID2_DarkRiver.jpg" style='height:500px' ></center>
                    </div>
                    <div class="carousel-item">
                        <center><img src="Images/DarkRiver/DarkRiver1.jpg" style='height:500px' ></center>
                    </div>
                    <div class="carousel-item">
                        <center><img src="Images/DarkRiver/DarkRiver2.jpg" style='height:500px' ></center>
                    </div>
                    <div class="carousel-item">
                        <center><img src="Images/DarkRiver/DarkRiver3.jpg" style='height:500px' ></center>
                    </div>
                    <div class="carousel-item">
                        <center><img src="Images/DarkRiver/DarkRiver4.jpg" style='height:500px' ></center>
                    </div>
                    <div class="carousel-item">
                        <center><img src="Images/DarkRiver/DarkRiver5.jpg" style='height:500px' ></center>
                    </div>
                </div>
