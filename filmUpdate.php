...
<div class="add-form"> 
             ...
             <h2>Update film details</h2>
                ...
                <div><?php echo $filmUpdateMsg; ?></div>
                ...
                Synopsis:<textarea id="filmSynopsis" class="form-control" placeholder=""  name="filmSynopsis"  value="<?=$film['fm_SYNOPSIS']?>" required autofocus="true"rows="4" cols=""></textarea>
                <br/>
                
              
           <input type="submit" value=" Update Film " name="updateFilm" id="submit-button" class="btn btn-primary" onclick="clearField()" />
